...
const BEACH_DIR = join(import.meta.dirname, 'mock-data/beach');
const NGROK_HEADERS = { 'ngrok-skip-browser-warning': 'true' };
const MAX_BYTES = 4.5 * 1024 * 1024;

const BEACH_PHOTOS = [
  'pexels-efrem-efre-2786187-33949174.jpg',
  'pexels-fernando-silva-2157007356-34692556.jpg',
  'pexels-fernando-silva-2157007356-35569915.jpg',
  'pexels-filipgrobgaard-15751396.jpg',
  'pexels-ivett-35984830.jpg',
];
...
async function addBeachPhoto(email, photoFile) {
  ...
  const photoPath = join(BEACH_DIR, photoFile);
...
async function main() {
  ...
  for (let i = 0; i < accounts.length; i++) {
    const photo = BEACH_PHOTOS[i % BEACH_PHOTOS.length];
    try {
